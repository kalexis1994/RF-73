...
use rf_tines_dsp::{ElectromechanicalAssembly, ElectromechanicalProfile, ProductionDecimator};
...
pub const HELP: &str = "Electromechanical audit:
  ...
  loaded-damper-seating --output REPORT.json
  loaded-damper-lift --output REPORT.json
