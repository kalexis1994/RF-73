...
use rf_tines_analysis::{AudioClip, Comparison, compare};
use rf_tines_dsp::{FIRST_NOTE, LAST_NOTE, Profile, Voice};
use serde::Serialize;
...
mod tests {
    ...
    fn sampled_production_kernel_matches_real_filter_and_preserves_physical_delay() {
        let mut real = rf_tines_dsp::ProductionDecimator::new();
