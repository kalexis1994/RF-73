...
pub mod observer;
pub mod reduced;
use rf_tines_dsp::{ModalAssembly, ModalAssemblyProfile, ModalIntegration, TineGeometry};
use serde::Serialize;
...
fn simulate_observed(
    ...
    structural: f64,
    damper: f64,
    mut observe: impl FnMut(usize, usize, &rf_tines_dsp::ModalProbe, &rf_tines_dsp::ModalProbe, bool),
