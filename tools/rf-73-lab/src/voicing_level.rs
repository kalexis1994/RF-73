...
pub fn run(args: &[String]) -> Result<(), Box<dyn Error>> {
    ...
    for law in [PickupLaw::Production, PickupLaw::Aperture] {
        for gap in GAPS_MM {
            for offset in OFFSETS_MM {
                ...
                cells.push(json!({
                    "law": match law { PickupLaw::Production => "production", PickupLaw::Aperture => "aperture" },
    ...
    let report = json!({
        ...
        "protocol": {
            ...
            "reference_motion": {"amplitude_m": rf_73_dsp::LEVEL_REFERENCE_AMPLITUDE_M, "frequency_hz": rf_73_dsp::LEVEL_REFERENCE_FREQUENCY_HZ},
