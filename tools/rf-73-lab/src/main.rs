...
const HELP: &str = "RF-73 research laboratory 0.1.2
Usage:
  rf-73-lab render --output PATH.wav [options]
  rf-73-lab demo --output PATH.wav
  rf-73-lab stress [--sample-rate HZ] [--laboratory]
  rf-73-lab inspect PATH.wav
  rf-73-lab package
  rf-73-lab build-ui
  rf-73-lab audition [--prepare-only]
Render options:
