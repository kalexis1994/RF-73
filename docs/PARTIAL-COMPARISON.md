...
```text
cargo run --locked --release -p rf-tines-lab -- compare-partials references/audio/a3.wav renders/a3.wav --output renders/a3-partials.json --seconds 2 --reference-start 0.2 --candidate-start 0.2
```
