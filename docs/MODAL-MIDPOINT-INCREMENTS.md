...
```text
cargo run --locked --release -p rf-tines-lab -- memory-modal-rk4-refinement --output renders/increment-refinement.json
cargo run --locked --release -p rf-tines-lab -- modal-hammer-check --output renders/increment-hammer.json
cargo run --locked --release -p rf-tines-lab -- memory-modal-adaptive-check --output renders/increment-adaptive.json
cargo run --locked --release -p rf-tines-lab -- memory-modal-economical-check --output renders/increment-economical.json
cargo run --locked --release -p rf-tines-lab -- memory-modal-free-check --output renders/increment-free.json
```
