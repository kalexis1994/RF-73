...
matches the workspace version exactly. Pushing `v0.2.1`, for example, can only
publish a package whose Cargo and RackForge manifests both declare `0.2.1`.
...
```text
git tag -a v0.2.1 -m "RF-Tines 0.2.1"
