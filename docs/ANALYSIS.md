...
cargo run --locked --release -p rf-tines-lab -- analyze renders/a3.wav --output renders/a3-attack.json --note 57 --partial-window-ms 32
cargo run --locked --release -p rf-tines-lab -- analyze references/audio/a3.wav --output renders/a3-sustain.json --note 57 --partial-window-ms 1024 --sustain-end 5
cargo run --locked --release -p rf-tines-lab -- compare references/audio/a3.wav renders/a3.wav --output renders/comparison.json --align-ms 20
```
