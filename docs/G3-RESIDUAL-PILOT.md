...
```text
cargo run --locked --release -p rf-tines-lab -- render --output renders/g3-baseline.wav --note 55 --velocity 0.9 --sample-rate 44100 --seconds 3 --hold 2.8
...
cargo run --locked --release -p rf-tines-lab -- sweep-pickup references/audio/jrhodes-g3-a886e6c/A_055__G3_1.wav --output renders/g3-sweep.json --note 55 --velocity 0.9 --seconds 0.6 --gaps-mm 0.5,0.75,1,1.5,2 --offsets-mm 0,0.25,0.5,0.75,1
```
