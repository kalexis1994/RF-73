...
```text
cargo run --locked --release -p rf-tines-lab -- memory-modal-free-check --output renders/material-solve-modal.json
cargo run --locked --release -p rf-tines-lab -- memory-free-check --output renders/material-solve-wall.json
cargo run --locked --release -p rf-tines-lab -- memory-modal-free-timing --output renders/material-solve-timing.json
```
