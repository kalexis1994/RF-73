...
```text
cargo run --locked --release -p rf-tines-lab -- pickup-transfer --output renders/transfer-default.json
cargo run --locked --release -p rf-tines-lab -- pickup-transfer --output renders/transfer-close.json --gap-mm 0.5 --offset-mm 0.25
cargo run --locked --release -p rf-tines-lab -- pickup-transfer --output renders/transfer-treble.json --period-frames 16 --gap-mm 0.5 --offset-mm 0.25 --amplitudes-mm 0.75,3
```
