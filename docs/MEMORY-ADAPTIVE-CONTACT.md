...
```text
cargo run --locked --release -p rf-tines-lab -- memory-modal-adaptive-check --output renders/modal-adaptive.json
cargo run --locked --release -p rf-tines-lab -- memory-modal-adaptive-timing --output renders/modal-adaptive-timing.json
```
