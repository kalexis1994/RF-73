...
```text
cargo run --locked --release -p rf-tines-lab -- render --output renders/pickup-set-demo/soft.wav --note 57 --velocity 0.3 --seconds 1.5 --hold 1.4 --gap-mm 2 --offset-mm 0.75
cargo run --locked --release -p rf-tines-lab -- render --output renders/pickup-set-demo/loud.wav --note 57 --velocity 0.7 --seconds 1.5 --hold 1.4 --gap-mm 2 --offset-mm 0.75
cargo run --locked --release -p rf-tines-lab -- render --output renders/pickup-set-demo/held.wav --note 57 --velocity 0.5 --seconds 1.5 --hold 1.4 --gap-mm 2 --offset-mm 0.75
