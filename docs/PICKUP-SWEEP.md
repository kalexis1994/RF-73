...
```text
cargo run --locked --release -p rf-tines-lab -- render --output renders/known-pickup.wav --note 57 --velocity 0.7 --seconds 1.5 --hold 1.4 --gap-mm 2 --offset-mm 0.75
cargo run --locked --release -p rf-tines-lab -- sweep-pickup renders/known-pickup.wav --output renders/pickup-sweep.json --note 57 --velocity 0.7 --seconds 1 --reference-start 0.1 --model-start 0.1 --gaps-mm 1.5,2,2.5 --offsets-mm 0.5,0.75,1
```
