...
```text
cargo run --locked --release -p rf-tines-lab -- memory-hammer-check --output renders/memory-hammer.json
cargo run --locked --release -p rf-tines-lab -- memory-hammer-check --output renders/memory-hammer-coarse.json --substeps 32
```
