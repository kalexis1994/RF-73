...
```text
cargo run --locked --release -p rf-tines-lab -- memory-modal-rk4-check --output renders/modal-rk4.json
cargo run --locked --release -p rf-tines-lab -- memory-modal-rk4-timing --output renders/modal-rk4-timing.json
cargo run --locked --release -p rf-tines-lab -- memory-modal-economical-check --output renders/modal-rk4-control.json
```
