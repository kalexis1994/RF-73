...
- After producing a version for the user to test, run `cargo run --locked --release -p rf-tines-lab -- audition` from this workspace. This is the standard build, package, install and Desktop launch workflow.
