...
use rf_rhodes_plugin::{RhodesProcessor, STATE_BYTES};

fn begin(plugin: &mut RhodesProcessor, id: Option<&str>) -> PreparedProgram {
...
fn state(plugin: &RhodesProcessor) -> [u8; STATE_BYTES] {
