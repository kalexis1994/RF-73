...
use crate::{RhodesProcessor, STATE_VERSION, Settings};
...
pub fn begin(plugin: &RhodesProcessor, request: &[u8], destination: &mut [u8]) -> Option<usize> {
...
pub fn install(plugin: &mut RhodesProcessor, bytes: &[u8]) -> bool {
